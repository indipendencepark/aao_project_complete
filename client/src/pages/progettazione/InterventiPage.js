    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth scroll="paper">
             <DialogTitle sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                Modifica Intervento: {intervento.titolo} {}
...
const InterventiPage = () => {
    ...
    const handleSaveEditIntervento = async (id, formData) => {
         ...
         try {
             ...
             fetchInterventi(true);
         } catch (err) { setError(err.response?.data?.message || 'Errore aggiornamento.');  }
         finally { setSavingEdit(false); }
    };
                    ...
                    <>
                        ...
                        <Paper sx={{ p: 2, mb: 3 }}>
                         ...
                         <Dialog open={openDeleteDialog} onClose={handleCloseDeleteDialog}>
                            ...
                            <DialogActions>
                                <Button onClick={handleCloseDeleteDialog} disabled={savingEdit}>Annulla</Button> {}
